...
export default function NRIPage() {
  ...
  return (
    <main ref={containerRef} className="bg-bg-primary min-h-screen selection:bg-accent selection:text-black">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 text-center">
          ...
          >
            ...
            <h1 className="font-heading text-6xl md:text-8xl lg:text-9xl font-bold text-white mb-8 leading-[0.9] tracking-tighter">
              Your Roots. <br />
              <span className="text-white/20">Our Commitment.</span>
            </h1>
            <p className="text-white/60 text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed font-light">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-4 opacity-20">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-center">
            ...
            <div className="lg:col-span-7">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-white/5 border border-white/5 rounded-[3rem] overflow-hidden">
      ...
      <SectionWrapper className="bg-bg-secondary rounded-[5rem] py-32">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-24">
            <span className="text-accent font-mono text-xs tracking-[0.3em] uppercase mb-4 block">The Journey</span>
            <h2 className="font-heading text-5xl md:text-7xl font-bold text-white">Seamless Transparency.</h2>
          </div>
      ...
      <SectionWrapper className="py-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="bg-white/5 p-16 md:p-24 rounded-[4rem] border border-white/5 relative overflow-hidden">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
              <div>
                <h2 className="font-heading text-4xl md:text-5xl font-bold text-white mb-8">Dedicated NRI Concierge.</h2>
...
const StatCard = ({ label, value }: { label: string, value: string }) => (
  <div className="p-12 bg-bg-secondary hover:bg-accent/5 transition-colors duration-500 text-center sm:text-left">
    <div className="font-heading text-5xl font-bold text-white mb-4">{value}</div>
...
const ProcessStep = ({ number, title, description }: { number: string, title: string, description: string }) => (
  <motion.div 
    ...
    viewport={{ once: true }}
    className="relative z-10 bg-bg-primary p-10 rounded-[3rem] border border-white/5 hover:border-accent/20 transition-all duration-500 group"
  >
